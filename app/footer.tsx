    ...
    <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
      <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
        ...
        <div className="flex justify-center">
          <a href="https://ko-kr.facebook.com/HappyFinance/" className="mr-6 text-gray-600">
          ...
          <a href="https://www.youtube.com/channel/UCw00vX9nr7gRFYI4BpHEWig" className="mr-6 text-gray-600">
          ...
          <a href="https://www.instagram.com/hf_happyfinance" className="mr-6 text-gray-600">
          ...
          <a href="https://github.com/dhkim9549/hf-api-web" className="text-gray-600">
        ...
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="">
            ...
            <p className="lg:text-left">
              공공데이터포털을 통해 제공하는 한국주택금융공사 오픈 API
            </p>
          </div>
          <div className="">
